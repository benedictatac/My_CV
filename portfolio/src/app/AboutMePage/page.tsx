...
export default function AboutMePage() {
  ...
  <div
    ...
    {/*First Item*/}
    <div
      className="relative float-left -mr-[100%] w-full !transform-none opacity-100 transition-opacity duration-[600ms] ease-in-out motion-reduce:transition-none"
